...
function App() {
  ...
  const [beeHouseWidth, setBeeHouseWidth] = useState('500px');
  ...
  useEffect(() => {
    ...
    setBeeHouseWidth(window.innerWidth <= 768 ? '300px' : '500px');
      ...
      <main className="main-content">
        <section className="hero-section">
          <div className="hero-content-wrapper">
            ...
            <div className="beehive-image-container" style={{ marginRight: '-50px', position: 'relative', zIndex: 4 }}>
              <Image src={beeHiveImage} alt="Beehive with monitoring system" className="beehive-image" width={400} height={400} />
            </div>
          </div>
        </section>
        ...
        <section id="problem" className="problem-section">
          ...
          <div className="discover-solution">
            ...
            <Image src={honeySpoon} alt="Honey spoon" className="honey-spoon-image" width={200} height={200} />
          </div>
        </section>
